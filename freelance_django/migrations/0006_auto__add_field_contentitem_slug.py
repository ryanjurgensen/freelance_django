...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentItem.slug'
        db.add_column(u'freelance_django_contentitem', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentItem.slug'
        db.delete_column(u'freelance_django_contentitem', 'slug')
